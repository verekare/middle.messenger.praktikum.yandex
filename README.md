...
Удалите текст, который был по умолчанию сгенерирован в README.md. Расскажите в README.md о вашем проекте и не забудьте перечислить команды, которые в нём используются (например, для сборки и запуска). Добавьте в README.md ссылки на все свёрстанные страницы (включая 404 и 500).
